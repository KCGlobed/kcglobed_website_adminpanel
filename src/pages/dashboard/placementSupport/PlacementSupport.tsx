...
const PlacementSupport: React.FC = () => {
    ...
    const handleSendExport = async () => {
        ...
        dispatch(getPlacementSupportForExport({ type: exportType, payload }))
    ...
    return (
        <div className='overflow-x-hidden'>
            <div className="flex mb-4 gap-4 justify-between">
                <h2 className="text-2xl font-bold text-gray-800">Placement Support Reports</h2>
                {
