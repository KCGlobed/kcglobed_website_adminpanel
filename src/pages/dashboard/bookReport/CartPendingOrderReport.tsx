...
import { getPendingBook, getPendingBookForExport } from '../../../store/slices/bookOrderSlice';
import { Columns } from './column';


const CartPendingOrderReport: React.FC = () => {
  ...
  const handleSendExport = async () => {
    ...
    dispatch(getPendingBookForExport({ type: exportType, payload }))
...
export default CartPendingOrderReport; 