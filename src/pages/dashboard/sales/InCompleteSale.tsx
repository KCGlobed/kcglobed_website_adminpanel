...
import { getActiveSalesExcel, getInitiateSales } from '../../../store/slices/salesSlice';


const InCompleteSale: React.FC = () => {
    ...
    const subscriptionColumns: ColumnDefinition<Subscription>[] = useMemo(() => [
        ...
        {
            key: 'order_date', title: 'Order Date', align: 'center', render: (_, row) => {
    ...
    useEffect(() => {
        dispatch(getInitiateSales({ page: currentPage } as any) as any);
    ...
    return (
        <div className='overflow-x-hidden'>
            <div className="flex mb-4 gap-4 justify-between">
                <h2 className="text-2xl font-bold text-gray-800">InComplete Subscriptions</h2>
                {
